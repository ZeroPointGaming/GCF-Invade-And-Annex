...
private ["_v","_t","_d","_s","_i","_sd","_sp","_ti","_u", "_lk"];
...
while {true} do {
	...
	//Respawn prowlers locked
	_prowlerClassArray = ["B_T_LSV_01_armed_F", "B_T_LSV_01_armed_CTRG_F", "B_T_LSV_01_unarmed_F", "B_T_LSV_01_unarmed_CTRG_F", "B_LSV_01_armed_F", "B_LSV_01_unarmed_F", "B_LSV_01_armed_sand_F", "B_LSV_01_armed_olive_F", "B_LSV_01_armed_black_F", "B_CTRG_LSV_01_light_F", "B_LSV_01_unarmed_black_F", "B_LSV_01_unarmed_sand_F", "B_LSV_01_unarmed_olive_F"], "B_T_LSV_01_armed_black_F", "B_T_LSV_01_armed_olive_F", "B_T_LSV_01_armed_sand_F", "B_T_LSV_01_unarmed_black_F", "B_T_LSV_01_unarmed_olive_F", "B_T_LSV_01_unarmed_sand_F"];
	if ((typeOf _v in _prowlerClassArray)) then {
		//Lock the vehicle
		//_vehicle lock true;
		[_v,true] remoteExec ["lock", _v]; 
		
		//Lock the vehicles inventory
		//_vehicle lockCargo true;
		[_v,true] remoteExec ["lockCargo", _v]; 
	};
